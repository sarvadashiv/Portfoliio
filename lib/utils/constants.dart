...
const miniDescription =
    'With a custom development and creative design, I create software that inspire my clients, and Increase their sales by reaching their Target audience efficiently';
const aboutFirst =
    'Hello! I\'m a Developer \n\nI enjoy creating things that live on the internet, whether that be websites, applications, or anything in between. My goal is to always build products that provide pixel-perfect, performant experiences.\n\n';
const aboutSecond =
    'Shortly currently, I am pursuing my Bachelor\'s degree in Computer science and Engineering at Ajay Kumar Garg Engineering Collge, as well as I work on a wide variety of interesting and meaningful projects on a daily basis.\n\n';
const education =
...
const skill =
    'Currently App and Backend Dev and I offer more than just programming skills.';
